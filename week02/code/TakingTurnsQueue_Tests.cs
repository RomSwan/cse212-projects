...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue method in PersonQueue.cs was not adding people to the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson() in TakingTurnsQueue.cs was not accounting for infinite turns.
