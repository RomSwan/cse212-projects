public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: trying to dequeue at the wrong index. (Lines 69-70)
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Code pushed each value to the front instead of the back like a proper queue. (Line 57)
